...
//        newGraph.addWeightedEdge(1, 2, 6);
//        newGraph.addWeightedEdge(1, 3, 1);
//        newGraph.addWeightedEdge(1, 4, 8);
//        newGraph.addWeightedEdge(2, 5, 8);
//        newGraph.addWeightedEdge(3, 4, 4);
//        newGraph.addWeightedEdge(4, 6, 9);
//        newGraph.addWeightedEdge(5, 6, 7);
//        System.out.println("Printing Bellman from source A: ");
//        newGraph.bellmanFord(nodeList.get(0));
        ...
        nodeList.add(new WeightedNode("C", 2));
        nodeList.add(new WeightedNode("D", 3));
        WeightedGraph newGraph3 = new WeightedGraph(nodeList);
        newGraph3.addWeightedEdge(0, 3, 1);
        newGraph3.addWeightedEdge(0, 1, 8);
        newGraph3.addWeightedEdge(1, 2, 1);
        newGraph3.addWeightedEdge(2, 0, 4);
        newGraph3.addWeightedEdge(3, 1, 2);
        newGraph3.addWeightedEdge(3, 2, 9);
        System.out.println("Print FW algorithm from source of: A");
        newGraph3.floydWarshall();
